...
## Set by Kieran, 4 June 2026 (Updated: 4 June 2026)
...
| [ASIMPLEXIS]    | Asimplexis — AI build engine          | 6a1c237bd9f5ff04b6ac7a73      |
...
## Name Change Log
- [NEXUS] → [ASIMPLEXIS] renamed 4 June 2026
- App: Nexus Command → Asimplexis (ID: 6a1c237bd9f5ff04b6ac7a73)
- Domain: asimplexis.com connected via Squarespace

---

## Isolation Rules

1. Functions and entities built for [ASIMPLEXIS] must NEVER be called from [5S-PORTAL] and vice versa.
...
5. Cross-namespace actions (e.g. syncing 5S Portal data to Asimplexis) require explicit approval and are logged as a checkpoint.

---

## How Simpee Tags Outputs
Every significant output, memory entry, or code file will be prefixed:
- Code commits: "[ASIMPLEXIS] fix: ..." or "[5S-PORTAL] feat: ..."
- Memory entries: ### [ASIMPLEXIS] / ### [SIMPLEX-ITY] etc.
